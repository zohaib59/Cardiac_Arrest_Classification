...
data = pd.read_csv("cardiac_risk_synthetic.csv",encoding='Latin1')
...
def class_distribution(data, column_name='Cardiac_Arrest_Risk'):
...
class_distribution(data, 'Cardiac_Arrest_Risk')
...
X = data.drop("Cardiac_Arrest_Risk", axis = 1)

y = data["Cardiac_Arrest_Risk"]
